...
//  Meter
//
//  Created by Avery Lamp on 7/31/17.
...
struct SpotKeys {
    ...
    static let Available = "isAvailable"
...
struct UserKeys {
    ...
    static let FacebookLocation = "facebookLocation"
    static let LastReportedLocation = "lastReportedLocation"
    static let LastReportedAddress = "lastReportedAddress"
    static let Username = "username"
    static let Email = "email"
    static let StayRatings = "stayRatings"
    static let LendRatings = "lendRatings"
    static let OwnedSpots = "ownedSpots"
    static let PhoneNumber = "phoneNumber"
    static let PhoneVerified = "phoneNumberVerified"
